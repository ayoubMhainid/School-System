...
export const GradeStudents = () => {
  ...
  const getExamsBySubject_FUNCTION = async () => {
    const response = await getExamsBySubject(
      ...
      <div className="ml-6 mt-6 md:w-[98%]">
        ...
        <div className="mt-4 px-2">
          ...
          <p className="text-lg font-semibold">
            Select a subject and an exam to get students
          </p>
          <br></br>
          <div className="flex gap-2">
            <Select
              ...
              onchange={(e) => (
                ...
                setSelectedExam({ exam_name: "", class_id: 0, exam_id: 0 })
              )}
            ...
            <select
              ...
              onChange={(e) => {
                const selectedExamObj = exams.find(
                  (exam) => exam.class_id === parseInt(e.target.value)
                );
                setSelectedExam(
                  selectedExamObj || { exam_name: "", class_id: 0, exam_id: 0 }
                );
              }}
            >
