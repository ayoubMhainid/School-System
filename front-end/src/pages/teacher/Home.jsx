    ...
    <div className="rounded-md shadow-md w-full  bg-white">
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 2 }}
        >
          <h1 className=" text-2xl   text-gray-500 font-semibold mb-6 md:mb-6 lg:text-gray-500">
            Explore Our Services
          </h1>
          <h1 className=" lg:text-5xl lg:w-[100%] w-[70%] text-2xl font-semibold mb-6">
            Welcome to Teacher Management
          </h1>
          <h3 className=" w-[100%] text-xl text-gray-500   ">
            Managing teachers involves effective planning and organization to
            ensure high-quality education, including supporting and guiding
            them, evaluating their performance, and providing a motivating work
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:space-x-15 md:px-10">
          <div class="flex flex-col md:flex-row justify-center gap-6 p-6">
            <div class="w-full md:w-1/4 max-w-sm rounded-lg overflow-hidden shadow-lg bg-white">
              ...
              <div class="px-6 py-4">
                ...
                <p class="text-gray-700 text-xl">
                  Attendance is the act of being present at a designated place,
                  like school, work, or an event. It helps track participation,
                  responsibility, and commitment. Good attendance often reflects
                  reliability and discipline, playing an important role in
            ...
            <div class="w-full md:w-1/4 max-w-sm rounded-lg overflow-hidden shadow-lg bg-white">
              ...
              <div class="px-6 py-4">
                ...
                <p class="text-gray-700 text-xl">
                  ...
                  activities to create a positive and productive learning
                  environment. It includes setting rules, maintaining
                  discipline, planning lessons, and engaging students. Effective
                  class management helps ensure smooth communication, active
            ...
            <div class="w-full md:w-1/4 max-w-sm rounded-lg overflow-hidden shadow-lg bg-white">
              <img
                class="w-full h-48 object-cover"
                src="/EventsTeacher.jpeg"
                alt="Card Image 3"
              />
              <div class="px-6 py-4">
                <div class="font-bold text-3xl mb-2 text-gray-700 ">Events</div>
                <p class="text-gray-700 text-xl">
                  Events are organized activities that bring people together for
                  a common purpose, like celebrations, meetings, or learning
                  sessions. They help foster communication, teamwork, and a
                  sense of community. Well-planned events create memorable
                  experiences and encourage participation and engagement.
                </p>
              </div>
            </div>
            ...
            <div class="w-full md:w-1/4 max-w-sm rounded-lg overflow-hidden shadow-lg bg-white">
              ...
              <div class="px-6 py-4">
                ...
                <p class="text-gray-700 text-xl">
                  Managing exams involves planning, organizing, and overseeing
                  the entire examination process to ensure fairness, efficiency,
                  and accuracy. It includes tasks like preparing exam schedules,
                  creating question papers, coordinating with invigilators, and
                  providing clear instructions to students. Effective exam
                  management also involves handling logistics and maintaining
                  security
                </p>
              </div>
            </div>
      ...
      >
        ...
        >
          ...
          <p className="text-lg lg:text-xl 2xl:text-3xl leading-relaxed text-gray-300">
            ...
            expectations, and professional development to support growth and
            quality education. Encouraging collaboration, providing regular
            feedback, and recognizing efforts foster motivation and improvement.
            A fair evaluation system ensures accountability and addresses
